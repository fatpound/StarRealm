...
export namespace starrealm
{
    ...
    public:
        explicit Game()
            :
            m_wnd_(std::make_shared<FATSPACE_WIN32::WndClassEx>(L"fat->pound WindowClassEx: " + std::to_wstring(s_game_id_++)), L"StarRealm " + std::to_wstring(s_game_id_), FATSPACE_UTILITY::SizePack{ ScreenWidth, ScreenHeight }),
