...
export module StarRealm.Entity.Examples.HollowMulti;
...
{
    class HollowMulti final : public StarBase<STARREALM_STAR_TYPE::Hollow, STARREALM_STAR_EFFECT::MultiColor>
    {
    public:
