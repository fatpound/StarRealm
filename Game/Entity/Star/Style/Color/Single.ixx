...
export namespace starrealm::entity::star_style::color
{
    ...
    public:
        ...
        {
            auto pvs = std::make_unique<FATSPACE_D3D11::pipeline::VertexShader>(gfx.GetDevice(), L"VSColorSingle.cso");
            auto pvsbc = pvs->GetBytecode();
            StarBase::AddStaticBind_(std::move<>(pvs));
            StarBase::AddStaticBind_(std::make_unique<FATSPACE_D3D11::pipeline::PixelShader>(gfx.GetDevice(), L"PSColorSingle.cso"));
            ...
            StarBase::AddStaticBind_(std::make_unique<FATSPACE_D3D11::pipeline::InputLayout>(gfx.GetDevice(), ied, pvsbc));
        }
